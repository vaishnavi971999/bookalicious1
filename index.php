<?php
	...
	<!--/Jumbotron -->
	    <div class="jumbotron index">
	      <div class="container">
			  <h1 style="text-align:left; color:blue; margin-left:50px;">Bookalicious<i class="glyphicon glyphicon-book"></i> </h1>
	      <h3 style="color:blue; margin-left:50px;">Buy and sell your books here!!!</h3>
		  <br><br>
	...
	<footer style="color:black; text-align:left; padding-left:50px;">
        <b><p>For more details, contact us:</p>
        <p>Email us at: bookalicious@gmail.com</p>
        <p>Ring us at: 1200 930 234</p></b>
      </footer>
    </div> <!-- /container -->
