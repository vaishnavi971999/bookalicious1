...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(mysqli_num_rows($result)>0){ //
        $err = "Inserted successfully. Whenever another uses buys your book, the book will be collected from you by paying the cost mentioned.";
    }
    else{
        $err = "cannot insert";
    }
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        $msg = "Image uploaded successfully. Book inserted.  Whenever another uses buys your book, the book will be collected from you by paying the cost mentioned.";
    }else{
